...
class maizeResorce extends StatefulWidget {
  // final String res;
  // maizeResorce({required this.res});
  maizeResorce({Key? key}) : super(key: key);

  @override
  State<maizeResorce> createState() => _maizeResorceState();
}

class _maizeResorceState extends State<maizeResorce> {
  ...
  String _resourceMaize = '_resourceMaize'.tr();
  @override
                ...
                children: [
                  IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await flutterTts.speak("${_resourceMaize}");
                      },
                      icon: const Icon(
                        Icons.volume_up,
                        size: 29,
              ...
              SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      //           image: AssetImage("assets/maize.jpg"),
                      //           fit: BoxFit.cover,
                      //         ), //DecorationImage
                      //       ), //BoxDecoration
                      //       //Text
