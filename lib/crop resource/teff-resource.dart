...
class teffResource extends StatefulWidget {
  // teffResource({required this.res});
  teffResource({Key? key}) : super(key: key);

  @override
  State<teffResource> createState() => _teffResourceState();
}

class _teffResourceState extends State<teffResource> {
                ...
                children: [
                  IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await flutterTts.speak("${_resourceTeff}");
                      },
                      icon: const Icon(
                        Icons.volume_up,
                        size: 29,
