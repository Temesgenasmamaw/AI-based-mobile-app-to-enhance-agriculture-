...
class wheatResource extends StatefulWidget {
  wheatResource({Key? key}) : super(key: key);

  @override
  State<wheatResource> createState() => _wheatResourceState();
}

class _wheatResourceState extends State<wheatResource> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Recomend wheatResource'),
        actions: [],
      ),
