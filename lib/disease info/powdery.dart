...
class PowderyMangoDisease extends StatefulWidget {
  const PowderyMangoDisease({super.key});

  @override
  State<PowderyMangoDisease> createState() => _PowderyMangoDiseaseState();
}

class _PowderyMangoDiseaseState extends State<PowderyMangoDisease> {
