...
class barlyResult extends StatefulWidget {
  final String res;
  barlyResult({required this.res});
  // barlyResult({Key? key}) : super(key: key);

  @override
  State<barlyResult> createState() => _barlyResultState();
}

class _barlyResultState extends State<barlyResult> {
                ...
                children: [
                  IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await flutterTts.speak("barleyResult".tr()+_resourceBarley);
                      },
                      icon: const Icon(
                        Icons.volume_up,
                        size: 29,
